...
- [ ] 8.2 Test onboarding flow on fresh install
- [ ] 8.3 Test consent checkboxes work correctly
- [ ] 8.4 Test data deletion with double confirmation
- [ ] 8.5 Test data export generates valid JSON
- [ ] 8.6 Test Light/Dark theme consistency
